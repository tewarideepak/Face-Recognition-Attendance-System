...
class Student:
    def __init__(self,root):
        ...
        dep_combo=ttk.Combobox(current_course_frame,textvariable=self.var_dep,font=("times new roman",12,"bold"),state="readonly",width=25)
        ...
        course_combo=ttk.Combobox(current_course_frame,textvariable=self.var_course,font=("times new roman",12,"bold"),state="readonly",width=25)
        ...
        year_combo=ttk.Combobox(current_course_frame,textvariable=self.var_year,font=("times new roman",12,"bold"),state="readonly",width=25)
        ...
        semester_combo=ttk.Combobox(current_course_frame,textvariable=self.var_semester,font=("times new roman",12,"bold"),state="readonly",width=25)
        ...
        btn_frame.place(x=0,y=200,width=715,height=37)
        ...
        btn_frame1.place(x=0,y=230,width=715,height=37)

        take_photo_btn=Button(btn_frame1,text="Take Photo Sample",command=self.generate_dataset,width=80,font=("times new roman",12,"bold"),bg="blue",fg="white")
        ...
        img_right=Image.open(r"college_images\right.jpg")
        ...
        table_frame.place(x=5,y=210,width=720,height=335)
    ...
    def reset_data(self):
        default_values = {
            ...
            'var_course': 'Select Course',
            'var_year': 'Select Year',
            'var_semester': 'Select Semester',
            'var_std_id': '',
            'var_std_name': '',
            'var_div': 'Select Division',
            'var_roll': '',
            'var_gender': 'Male',
            'var_dob': '',
            'var_email': '',
